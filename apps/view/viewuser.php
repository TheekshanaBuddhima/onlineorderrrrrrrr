...
if(isset($_POST['sub'])){
    ...
    $ob=new controller();
    $ob->updateusercontroller($_POST, $image_name, $image_tmp); 
                    ...
                    <div class="col-md-10">
                        <div class="pad1">
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <a href="" class="active"><?php echo ucfirst ($action) ;?> User</a>
                                </li>
                       ...
                       <img style="border-radius: 100px" src="<?php echo $path; ?>" width="200" />
                                    </div>                                   
                                    <div class="col-md-2">
                                        &nbsp;</div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="email" name="login_email" 
                                               ...
                                               class="form-control"
                                               autocomplete="no"
                                               value="<?php echo $row['login_email']; ?>"
                                                <?php
                                               //if($action=="view") 
                                                   echo "readonly";
                                               ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" name="user_dob" 
                                               ...
                                               class="form-control" 
                                               onchange="clearMsg('msg_dob')"
                                               
                                                value="<?php echo $row['user_dob']; ?>"
                                               <?php
                                               if($action=="view") echo "readonly";
                                               ?> />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <select name="user_gender"
                                                id="user_gender"
                                                class="form-control" 
                                                onchange="clearMsg('msg_gender')"
                                               <?php
                                               if($action=="view") echo "disabled";
                                               ?>>
                                            <option value="">
                                            ...
                                            <option value="Male"
                                     <?php 
                                     if($row['user_gender']=="Male") echo "selected"; 
                                     ?>
                                                    >
                                                Male
                                            </option>
                                            <option value="Female"
                                                    <?php 
                                     if($row['user_gender']=="Female") echo "selected"; 
                                     ?>
                                                    >
                                                Female
                                            </option>
                                        ...
                                        <select name="role_id" id="role_id"
                                            ...
                                            <option value="">
                                                ...
                                                <option value="<?php echo $rowr['role_id']; ?>"
                                                        <?php if($rowr['role_id']==$row['role_id']){
                                                            echo "SELECTED";
                                                        }?>
                                                        >
